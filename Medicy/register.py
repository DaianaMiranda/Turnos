...
class Register(tk.Frame):
    def __init__(self, parent, controller):
        ...
        boton_inicio = tk.Button(framel, text="Iniciar Sesión", bg="#F9DBED", command=lambda: controller.show_frame("Login"))
    ...
    def registrar_usuario(self):
        ...
        # Here you could add validation before attempting to create the user
        try:
